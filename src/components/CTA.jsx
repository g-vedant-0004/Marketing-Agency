    ...
    <section className='relative py-12'>
      <div className='max-w-7xl mx-auto bg-[#F3F3F3] rounded-md sm:pt-24 pt-8 pb-12 flex flex-col md:flex-row items-center justify-between px-4 sm:px-6 lg:px-8'>
        ...
        <motion.div
          ...
          <p className='text-gray-600 mb-6'>Contact us today to learn more about how our digital marketing services can help your business grow and succeed online.</p>
        ...
        <motion.div
          ...
          <img src={ctaImage} alt="cta image" className='md:absolute md:-top-52 md:bottom-0' style={{ transform: 'scale(1.05)' }} />
        </motion.div>
      </div>
    </section>
  )
